...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-4xl leading-none font-paytone", className)}
      {...props}
    />
  );
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-muted-foreground text-lg leading-[130%]", className)}
      {...props}
    />
  );
}
