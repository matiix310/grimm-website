...
DEFAULT_HELLOASSO_CLIENT_ID=""
DEFAULT_HELLOASSO_CLIENT_SECRET=""
...
create_env_file() {
    ...
    HELLOASSO_CLIENT_ID=$(read_input "HELLOASSO_CLIENT_ID" "HelloAsso Client ID" "$DEFAULT_HELLOASSO_CLIENT_ID")
    HELLOASSO_CLIENT_SECRET=$(read_input "HELLOASSO_CLIENT_SECRET" "HelloAsso Client Secret" "$DEFAULT_HELLOASSO_CLIENT_SECRET")
